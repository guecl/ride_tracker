...
public class RestControllerTest {
	...
	public void testCreateRide() {
		...
		restTemplate.postForEntity("http://localhost:8080/ride_tracker/ride", ride, Ride.class);
...
//		System.out.println("Ride id: " + ride.getId());
	...
	public void testGetRide() {
		...
		System.out.println("Ride Id = " + ride.getId() + ", Ride name: " + ride.getName() + ", Ride duratiob: " + ride.getDuration());
	...
	public void testDelete() {
		RestTemplate restTemplate = new RestTemplate();
		restTemplate.delete("http://localhost:8080/ride_tracker/delete/17", Object.class);
